...
use crate::reader::validation::{CommentValidationIter, EventValidationIter, ValidationError};
...
impl<'i> Event<'i> {
    ...
    /// [replacement text]: https://www.w3.org/TR/xml11/#dt-repltext
    pub fn validate(&self) -> EventValidationIter<'_> {
        match self {
            // Self::Start(e) => EventValidationIter::Start(e.validate()),
            // Self::End(e) => EventValidationIter::End(e.validate()),
            // Self::Empty(e) => EventValidationIter::Start(e.validate()),
            // Self::Text(e) => EventValidationIter::Text(e.validate()),
            // Self::CData(e) => EventValidationIter::CData(e.validate()),
            Self::Comment(e) => EventValidationIter::Comment(e.validate()),
            // Self::Decl(e) => EventValidationIter::Decl(e.validate()),
            // Self::PI(e) => EventValidationIter::PI(e.validate()),
            // Self::DocType(e) => EventValidationIter::Doctype(e.validate()),
            // Self::GeneralRef(e) => todo!("{e:?}"),
            // Self::Eof => todo!(),
            _ => todo!()
        }
    }
